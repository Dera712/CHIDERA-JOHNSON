...
- **Baseline/** – TF-IDF and Cosine Similarity candidate matching.
- **Enhanced/** – NLP-based skill extraction, Candidate Suitability Score (CSS), Random Forest classification, and performance evaluation.
...
```bash
python Baseline/BaselineDSSR3.py
```

Run the enhanced system:

```bash
python Enhanced/EnhancedDSSR3.py
```
